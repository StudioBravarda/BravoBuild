...
public class BravoSteamUploadGameSettings : SerializedScriptableObject
{
    ...
    [TitleGroup("Version To Upload"), HideLabel]

    [ValueDropdown("@BravoBuildLog.Instance.GetListVersions()")]
    ...
    public void UpdateVDFs()
    {
        ...
        string chooseBuildFolderPath = BravoBuildLog.Instance.GetBuildWithVersion(VersionToUpload).GetFolderPath();
